...
**data** _optional_
: The dictionary to embed with the link. Accessed as session or install parameters from the SDK. **All parameters below will need to be set within this data dictionary and not in the request body's root**.
